...
TEST(sadikov_d_crs_mult_omp, test_small_real_square_matrix) {
  matrix_CRS A;
  A.n = 5;
  A.m = 5;
  ...
  // Create Task
  CRSComplexMult_omp taskOmp(taskDataOmp);
...
TEST(sadikov_d_crs_mult_omp, test_small_real_nonsquare_matrix) {
  matrix_CRS A;
  A.n = 4;
  A.m = 5;
  A.row_id = {0, 3, 6, 8, 10};
...
TEST(sadikov_d_crs_mult_omp, test_small_complex_nonsquare_matrix) {
  matrix_CRS A;
  A.n = 4;
  A.m = 4;
  A.row_id = {0, 2, 4, 5, 7};
...
TEST(sadikov_d_crs_mult_omp, test_diagonal_1_1_matrix) {
  matrix_CRS A;
  A.n = 25;
  A.m = 25;
...
TEST(sadikov_d_crs_mult_omp, test_multiply_by_inverse_matrix) {
  matrix_CRS A;
  A.n = 4;
  A.m = 4;
  A.row_id = {0, 1, 3, 5, 8};
