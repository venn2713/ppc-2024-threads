...
TEST(ivanov_n_int_simpson_tbb, Linar_0_2) {
  const int a = 0;
  const int b = 2;
  const int c = 0;
  const int d = 2;
  ...
  // Create Task
  TestTBBTaskSequentialIvanovSimpson testTaskSequential(taskDataSeq, function);
  ...
  // Create Task
  TestTBBTaskParallelIvanovSimpson testOmpTaskParallel(taskDataPar, function);
...
TEST(ivanov_n_int_simpson_tbb, x_mul_y_5_10) {
  const int a = 5;
  const int b = 10;
  const int c = 2;
  const int d = 10;
...
TEST(ivanov_n_int_simpson_tbb, sin_cos_0_2_0_1) {
  const int a = 0;
  const int b = 2;
  const int c = 0;
  const int d = 1;
...
TEST(ivanov_n_int_simpson_tbb, liner_10_12_2_4) {
  const int a = 10;
  const int b = 12;
  const int c = 2;
  const int d = 4;
...
TEST(ivanov_n_int_simpson_tbb, x_mul_y_10_12_2_4) {
  const int a = 10;
  const int b = 12;
  const int c = 2;
  const int d = 4;
