...
#ifndef SOBEL_TBB_HPP
#define SOBEL_TBB_HPP
...
namespace sobol {
	...
	class Sobel_tbb : public ppc::core::Task {
	public:
		explicit Sobel_tbb(std::shared_ptr<ppc::core::TaskData> taskData_, int w_, int h_)
