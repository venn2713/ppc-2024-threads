...
TEST(mitin_r_double_radix_sort_seq, Test_Sort_two_value_test) {
  // Create data
  ...
  // Create Task
  SortRadixDoubleTaskSequential test(taskDataSeq);
...
TEST(mitin_r_double_radix_sort_seq, Test_Sort_simple) {
  // Create data
...
TEST(mitin_r_double_radix_sort_seq, Test_Sort_sorted) {
  // Create data
...
TEST(mitin_r_double_radix_sort_seq, Test_Sort_random_test) {
  // Create data
