...
void checkMatrixMultiplicationResult(const std::vector<uint8_t>& outputData,
  ...
  const double* outputMatrix = reinterpret_cast<
      const double*>(outputData.data());
