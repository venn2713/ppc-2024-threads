...
TEST(kasimtcev_r_monte_carlo, test_pipe) {
  double res = 8;
  func f = flinear;
...
TEST(kasimtcev_r_monte_carlo, test_task) {
  double res = 8;
  func f = flinear;
...
TEST(kasimtcev_r_monte_carlo, test_task1) {
  double res = 8;
  func f = flinear;
...
TEST(kasimtcev_r_monte_carlo, test_task2) {
  double res = 8;
  func f = flinear;
...
TEST(kasimtcev_r_monte_carlo, test_pipe1) {
  double res = 8;
  func f = flinear;
