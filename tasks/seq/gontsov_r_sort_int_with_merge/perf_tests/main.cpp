...
TEST(gontsov_r_sort_int_with_merge, test_pipeline_run) {
  ...
  // Create Task
  auto testTaskSequential = std::make_shared<RadixSortTaskSequential>(taskDataSeq);
...
TEST(gontsov_r_sort_int_with_merge, test_task_run) {
  const int count = 5000000;
