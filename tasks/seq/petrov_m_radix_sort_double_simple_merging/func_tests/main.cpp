...
TEST(Petrov_M_Radix_Sort_Sequential, Test_With_Positive_and_Negative_Numbers3) {
  std::vector<double> in{-87.5, 56.7, 22.4, -3.9, 42.2, -98.345,
  -77.4, 65.0, 92.1, -45.6, 33.8, -71.9, -24.2, 80.5, 49.4,
  -88.1, -19.2, 47.3, -52.6, 156.23, 120.57, 145.76, 177.05,
  101.32, 199.56, 178.91, 125.47, 113.28, 169.38, 104.55, 191.67,
  115.98, 180.62, 198.14, 129.93, 138.60, 175.20, 150.87,
  110.42,14.867, -33.199, 60.2, 29.1, -67.5,
  99.976, -4.7, -15.2, 73.6, -66.8, 23.4, -59.1, 88.7, -21.5,
  -40.9, 10.6, -11.8, 35.5, -81.6, 5.3, 76.4, -38.0, 91.232,
  28.7, -53.5, 64.3, -92.4, 18.6, 82.9, 57.8, -30.6
  };
  std::vector<double> sorted{-98.345, -92.4, -88.1, -87.5, -81.6,
  -77.4, -71.9, -67.5, -66.8, -59.1, -53.5, -52.6, -45.6,
  -40.9, -38.0, -33.199, -30.6, -24.2, -21.5, -19.2, -15.2,
  -11.8, -4.7, -3.9, 5.3, 10.6, 14.867, 18.6, 22.4, 23.4, 28.7,
  29.1, 33.8, 35.5, 42.2, 47.3, 49.4, 56.7, 57.8, 60.2,
  64.3, 65.0, 73.6, 76.4, 80.5, 82.9, 88.7, 91.232, 92.1, 99.976,
  101.32, 104.55, 110.42, 113.28, 115.98, 120.57, 125.47, 129.93,
  138.60, 145.76, 150.87, 156.23, 169.38, 175.20, 177.05, 178.91,
  180.62, 191.67, 198.14, 199.56
  };
  std::vector<double> out(in.size());
  std::shared_ptr<ppc::core::TaskData> taskDataSeq = std::make_shared<ppc::core::TaskData>();
  taskDataSeq->inputs.emplace_back(reinterpret_cast<uint8_t *>(in.data()));
