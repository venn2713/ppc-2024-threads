...
TEST(polozov_v_sort_hoar_batcher_seq, test_array_2) {
  // Create data
...
TEST(polozov_v_sort_hoar_batcher_seq, test_empty) {
  // Create data
...
TEST(polozov_v_sort_hoar_batcher_seq, test_one_number) {
  // Create data
...
TEST(polozov_v_sort_hoar_batcher_seq, test_with_negative) {
  // Create data
...
TEST(polozov_v_sort_hoar_batcher_seq, test_random) {
  // Create data
