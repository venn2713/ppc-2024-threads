...
TEST(nikitin_k_monte_carlo_integrals_seq, tested_linear_function) {
  double res = 8;
  func f = flinear;
...
TEST(nikitin_k_monte_carlo_integrals_seq, tested_of_x_multiply_y) {
  double res = 2.25;
  func f = fxy;
...
TEST(nikitin_k_monte_carlo_integrals_seq, tested_x_multiply_y_y) {
  double res = 1.5;
  func f = fxyy;
...
TEST(nikitin_k_monte_carlo_integrals_seq, testes_summ_of_sin) {
  double res = 5.67369;
  func f = fsinxsiny;
...
TEST(nikitin_k_monte_carlo_integrals_seq, tested_summ_of_cos) {
  double res = 6.22943;
  func f = fcosxcosy;
