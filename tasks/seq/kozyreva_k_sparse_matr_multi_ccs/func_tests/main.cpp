...
#include "seq/kozyreva_k_sparse_matr_multi_ccs/include/ccs_mat_multy.hpp"

TEST(kozyreva_k_sparse_matr_multi_ccs_seq, test_sizes) {
  size_t n1 = 4;
  size_t m1 = 4;
  size_t n2 = 4;
  size_t m2 = 4;
...
TEST(kozyreva_k_sparse_matr_multi_ccs_seq, test_sizes2) {
  size_t n1 = 4;
  size_t m1 = 5;
  size_t n2 = 3;
  size_t m2 = 4;
...
TEST(kozyreva_k_sparse_matr_multi_ccs_seq, test_multy_correct) {
  size_t n1 = 4;
  size_t m1 = 4;
  size_t n2 = 4;
  size_t m2 = 4;
...
TEST(kozyreva_k_sparse_matr_multi_ccs_seq, inverse_matrix) {
  size_t n1 = 3;
  size_t m1 = 3;
  size_t n2 = 3;
  size_t m2 = 3;
...
TEST(kozyreva_k_sparse_matr_multi_ccs_seq, zero_matrix) {
  size_t n1 = 3;
  size_t m1 = 3;
  size_t n2 = 3;
  size_t m2 = 3;
