// Copyright 2024 Sharapov GeorgiySSobelStl
...
TEST(sharapov_g_sobel_stl, Test_Seed_1234) {
  int width = 10;
  int height = 10;
  std::vector<SSobelStl::RGB> ColoredImage = {
  ...
  std::vector<SSobelStl::GrayScale> EdgeImageExpected = {
  ...
  // Task
  SSobelStl SSobelStl(taskDataSeq);
  ASSERT_EQ(SSobelStl.validation(), true);
  ASSERT_EQ(SSobelStl.pre_processing(), true);
  ASSERT_EQ(SSobelStl.run(), true);
  ASSERT_EQ(SSobelStl.post_processing(), true);
...
TEST(sharapov_g_sobel_stl, Test_Seed_2451) {
  int width = 10;
  int height = 10;
  std::vector<SSobelStl::RGB> ColoredImage = {
...
TEST(sharapov_g_sobel_stl, Test_Seed_2423) {
  int width = 10;
  int height = 10;
  std::vector<SSobelStl::RGB> ColoredImage = {
...
TEST(sharapov_g_sobel_stl, Test_Seed_2354) {
  int width = 10;
  int height = 10;
  std::vector<SSobelStl::RGB> ColoredImage = {
...
TEST(sharapov_g_sobel_stl, Test_Seed_3453) {
  int width = 10;
  int height = 10;
  std::vector<SSobelStl::RGB> ColoredImage = {
